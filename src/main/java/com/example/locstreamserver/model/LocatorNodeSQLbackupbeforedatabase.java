...
public class LocatorNodeSQLbackupbeforedatabase {
    int locatorId;
    String locatorMAC;
    String locatorName;
    ...
    public LocatorNodeSQLbackupbeforedatabase(int locatorId, String locatorName, int associatedCameraId, int accountId, String locatorMAC) {
    ...
    public boolean equals(Object o) {
        ...
        LocatorNodeSQLbackupbeforedatabase that = (LocatorNodeSQLbackupbeforedatabase) o;
